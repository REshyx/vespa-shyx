// SHYX adapter replacement for OpenFOAM `src/OpenFOAM/db/IOobject/IOobject.C`.
// Replaces the Make/files TU. Official Enum::get() FatalIOErrors if
// fileModificationChecking is missing during static init (TU order vs controlDict).
// getOrDefault(..., timeStamp) keeps LoadLibrary from killing ParaView.
...
(
    fileCheckTypesNames.getOrDefault
    (
        "fileModificationChecking",
        debug::optimisationSwitches(),
        fileCheckTypes::timeStamp
    )
);
