 ...
 *
 * Output is a vtkPolyData mixing VTK_LINE, VTK_POLY_LINE, and VTK_TRIANGLE cells. Each output cell has
 * cell data array SHYX_CheckReason: 1 = soup edge with >2 incident faces, 2 = boundary (hole) cycle,
 * 3 = triangle participating in a self-intersection (CGAL PMP::self_intersections).
 */
